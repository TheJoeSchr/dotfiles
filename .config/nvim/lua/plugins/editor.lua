...
return {
  -- Easymotion fuzzy search
  {
    ...
    keys = {
      ...
      { "<localleader>b", "<cmd>HopWordBC<cr>", desc = "Hop to word before cursor", mode = { "v", "n" } },
      { "<localleader>a", "<cmd>HopWord<cr>", desc = "Hop to word in current buffer", mode = { "v", "n" } },
      { "<localleader>w", "<cmd>HopWordAC<cr>", desc = "Hop to word after cursor", mode = { "v", "n" } },
      { "<localleader>c", "<cmd>HopCamelCaseMW<cr>", desc = "Hop to camelCase word", mode = { "v", "n" } },
      { "<localleader>k", "<cmd>HopLineBC<cr>", desc = "Hop to line up", mode = { "v", "n" } },
      { "<localleader>j", "<cmd>HopLineAC<cr>", desc = "Hop to line down", mode = { "v", "n" } },
      { "<localleader>f", "<cmd>HopNodes<cr>", desc = "Hop to node", mode = { "v", "n" } },
      { "<localleader>/", "<cmd>HopPatternMW<cr>", desc = "Hop to pattern", mode = { "v", "n" } },
