...
-- a seamless integration with the terminal so that you could grep/find/build
-- your project and direct the output to your editor without any hassle.
-- I have this seamless integration by having a simple custom binding that
-- creates a scratch buffer, runs a command, and sends the output to that scratch buffer:
...
-- but I do not want to manually close that buffer.
